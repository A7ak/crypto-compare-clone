...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull NewsViewHolder holder, final int position) {
        News news = listOfNewsArticles.get(position);
        ...
        holder.tvNewsPulishTime.setText(" "+listOfNewsArticles.get(position).getPublishedOn());
        ...
        String[] arrayNewsCategories = listOfNewsArticles.get(position).getCategories().split("\\|");
         for(String item:arrayNewsCategories)
         {
             ...
             holder.tvNewsCategories.append(item+"  ");
         }
        ;
    ...
    class NewsViewHolder extends RecyclerView.ViewHolder{
        ...
        public NewsViewHolder(@NonNull View itemView) {
            ...
            tvNewsPulishTime = itemView.findViewById(R.id.tv_news_publishing_time);
