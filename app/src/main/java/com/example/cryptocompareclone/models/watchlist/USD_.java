...
public class USD_ implements Serializable
{
    ...
    private final static long serialVersionUID = -6176246098480221923L;
    ...
    public String getCHANGEPCTHOUR() {
        return cHANGEPCTHOUR;
    }

    public void setCHANGEPCTHOUR(String cHANGEPCTHOUR) {
